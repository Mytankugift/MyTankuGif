    ...
    >
      ...
      >
        ...
        {!personalInfo?.id && (
          <LocalizedClientLink
            href="/account"
            className="bg-gradient-to-r from-[#66DEDB] to-[#73FFA2] text-black font-semibold px-4 py-2 sm:px-5 sm:py-2.5 rounded-full hover:shadow-lg hover:shadow-[#66DEDB]/25 transition-all duration-300 hover:transform hover:scale-105 text-xs sm:text-sm whitespace-nowrap flex-shrink-0"
          >
            Únete a Tanku
          </LocalizedClientLink>
        )}
