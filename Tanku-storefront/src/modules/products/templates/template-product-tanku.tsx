    ...
    <div className="bg-[#1E1E1E] min-h-screen text-white">
      <div className="container mx-auto px-4 sm:px-6 md:px-8 py-4 sm:py-6 md:py-8">
        ...
        <button
          ...
          className="mb-4 sm:mb-6 flex items-center gap-2 text-[#66DEDB] hover:text-[#73FFA2] transition-colors duration-200 group"
        >
          <svg 
            ...
            <div className="py-3 sm:py-4 md:py-6">
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="flex flex-col sm:flex-row sm:items-center">
                  ...
                  <Text className="text-white">{product.store?.name || 'N/A'}</Text>
                </div>
                <div className="flex flex-col sm:flex-row sm:items-center">
