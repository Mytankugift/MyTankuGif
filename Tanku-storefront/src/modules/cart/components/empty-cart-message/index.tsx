      ...
      <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 sm:gap-8 w-full max-w-2xl mx-auto">
        ...
        <div className="flex flex-col text-center sm:text-left">
          ...
          <div className="mt-2">
            <InteractiveLink 
              href="/store" 
              className="text-[#3B9BC3] hover:text-[#2A7A9B] text-sm sm:text-base font-medium px-4 py-2 border border-[#3B9BC3] rounded-lg hover:bg-[#3B9BC3]/10 transition-colors"
            >
              Explorar productos
            </InteractiveLink>
          </div>
