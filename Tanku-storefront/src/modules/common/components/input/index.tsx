      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex relative z-0 w-full txt-compact-medium">
          <input
            ...
            placeholder=" "
            required={required}
            className="pt-4 pb-1 block w-full h-11 px-4 mt-0 bg-transparent border-2 rounded-md appearance-none focus:outline-none focus:ring-0 border-[#73FFA2] hover:border-[#66DEDB] focus:border-[#66DEDB] text-white"
            {...props}
            ref={inputRef}
          />
          <label
