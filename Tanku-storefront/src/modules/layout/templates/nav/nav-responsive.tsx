...
export default function NavResponsive({ 
  ...
  return (
    <>
      ...
      <div className={`fixed bottom-0 left-0 right-0 z-40 lg:hidden transition-all duration-300 ease-in-out ${
        ...
        <nav 
          className="h-16 flex items-center justify-evenly px-1 py-1 -mb-1 flex-shrink-0"
          style={{ backgroundColor: '#2D3A3A' }}
        >
        {/* Inicio */}
        <LocalizedClientLink 
        ...
        <button 
          ...
          className={`flex flex-col items-center justify-center group hover:opacity-80 transition-all p-1 ${
