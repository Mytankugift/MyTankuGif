...
const ServicesDropdown = ({ 
  ...
  return (
    <div className="mb-0.5">
      <h3 className="mb-1 px-2" style={{ color: '#66DEDB', fontFamily: 'Poppins, sans-serif', fontSize: '16px', fontWeight: 500 }}>Servicios</h3>
      <div className="flex flex-col gap-0.5">
        ...
        <LocalizedClientLink
          href="/multipay"
          className="flex items-center gap-2.5 group hover:opacity-80 transition-opacity px-3 py-1.5 rounded-lg hover:bg-white/10 text-left"
          style={{ fontFamily: 'Poppins, sans-serif' }}
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 30 33" fill="none">
            <path d="M29 7.83203V24.5596L15.5156 31.8711L1.04688 24.583L1.00098 7.89062L15.4307 1.11035L29 7.83203Z" stroke="#73FFA2" strokeWidth="2"/>
  ...
  return (
    <>
      ...
      >
        ...
        {/* Menú vertical - sin scroll */}
        <div className="flex flex-col gap-1.5 flex-1 w-full px-2 pt-2 pb-2 overflow-hidden min-h-0">
          {/* Sección GivE-Commerce */}
          <div className="mb-0.5">
            <h3 className="mb-1 px-2" style={{ color: '#66DEDB', fontFamily: 'Poppins, sans-serif', fontSize: '16px', fontWeight: 500 }}>GivE-Commerce</h3>
            <div className="flex flex-col gap-0.5">
              {/* My TANKU */}
              <a 
                href="/" 
        ...
        {/* Área fija inferior con botones y footer */}
          ...
          <div className="px-4 py-1.5">
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-2 text-gray-400 text-sm">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0 text-[#73FFA2]">
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
                  <polyline points="22,6 12,13 2,6"></polyline>
                </svg>
                <a 
                  href="mailto:contacto@mytanku.com" 
                  className="hover:text-[#73FFA2] transition-colors break-all"
              ...
              <div className="flex items-center gap-2 text-gray-400 text-sm">
                ...
                <a 
                  ...
                  className="hover:text-[#73FFA2] transition-colors whitespace-nowrap"
                  style={{ fontFamily: 'Poppins, sans-serif', fontSize: '13px' }}
                >
                  +57 301 3363980
                </a>
