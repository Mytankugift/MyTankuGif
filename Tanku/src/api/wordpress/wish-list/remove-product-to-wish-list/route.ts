import { addProductToWishListWorkflow, createWishListWorkflow, deleteProductToWishListWorkflow } from "../../../../workflows/wish_list";
...
export const DELETE = async (req: MedusaRequest, res: MedusaResponse) => {
  try {
    ...
    const addItem = await deleteProductToWishListWorkflow(req.scope).run({
