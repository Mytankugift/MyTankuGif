import { model } from "@medusajs/framework/utils"
 ...
 const StalkerMessageStatus = model.define("stalker_message_status", {
  id: model.id().primaryKey(),
  message_id: model.text(), // ID del mensaje StalkerChatMessage
...
export default StalkerMessageStatus
