                  ...
                  <div key={u.id} className="p-4 space-y-3">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 inline-flex items-center justify-center gap-1 px-3 py-2 text-sm text-blue-600 border border-blue-200 rounded-lg hover:bg-blue-50"
                      >
                      ...
                      {u.id !== currentUser?.id && (
                        <button
                          ...
                          className="inline-flex items-center justify-center p-2 text-red-600 border border-red-200 rounded-lg hover:bg-red-50"
                          title="Eliminar"
                        >
                          <TrashIcon className="w-5 h-5" />
                        </button>
