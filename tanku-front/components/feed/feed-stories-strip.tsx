...
export interface FeedStoriesStripProps {
  ...
  /** Desktop: botón Explorar → enlace a sugerencias en /friends (las historias abren el visor) */
    ...
    <div className={clsx('w-full', className)} style={style}>
      ...
      >
        ...
        >
          ...
          <div className="pointer-events-none relative flex shrink-0 items-center gap-0 pr-0">
            {friendsSuggestionsHref ? (
              <Link
                href={friendsSuggestionsHref}
                className="pointer-events-auto relative z-10 hidden h-8 shrink-0 items-center rounded-l-[70px] rounded-r-none border-0 bg-[#2f3439] pl-5 pr-10 text-xl font-medium leading-none text-[#EAEAEA] transition-[background,background-image,color] duration-200 hover:bg-[linear-gradient(90deg,#73FFA2_0%,#405E4A_100%)] hover:text-white md:flex sm:h-9 sm:pl-6 sm:pr-14 sm:text-2xl"
                style={{
            ...
            <Image
              ...
              width={140}
              height={140}
              className="relative z-20 ml-1 hidden h-[88px] w-auto max-w-none shrink-0 object-contain object-center pointer-events-none sm:h-[108px] md:-ml-12 md:block md:h-[120px]"
              unoptimized
            />
          </div>
        </div>
